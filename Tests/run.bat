...
REM Apenas Coverage
:coverage
echo Executando testes com relatorio de cobertura...
%TEST_EXE% --coverage
goto end
...
echo   coverage   - Executar com relatorio de cobertura HTML
...
echo.
echo Exemplos:
echo   run.bat                    - Execucao padrao (todos os relatorios)
echo   run.bat console            - Apenas console
echo   run.bat xml                - Gerar arquivo XML
echo   run.bat html               - Gerar relatorio HTML
echo   run.bat coverage           - Gerar relatorio de cobertura HTML
echo   run.bat json               - Gerar relatorio JSON
echo   run.bat category Constructor - Apenas testes de construtor
echo   run.bat clean              - Limpar relatorios anteriores
echo.
...
echo.
echo Para visualizar o relatorio de cobertura:
echo   start %COVERAGE_DIR%\TestReport_*_coverage.html
echo.
pause