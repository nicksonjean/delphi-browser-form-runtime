...
type
  ...
  /// </remarks>
  TEdgeWebViewKeyEventKind                         = type COREWEBVIEW2_KEY_EVENT_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMoveFocusReason                      = type COREWEBVIEW2_MOVE_FOCUS_REASON;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewWebErrorStatus                       = type COREWEBVIEW2_WEB_ERROR_STATUS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewScriptDialogKind                     = type COREWEBVIEW2_SCRIPT_DIALOG_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPermissionState                      = type COREWEBVIEW2_PERMISSION_STATE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPermissionKind                       = type COREWEBVIEW2_PERMISSION_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewProcessFailedKind                    = type COREWEBVIEW2_PROCESS_FAILED_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewCapturePreviewImageFormat            = type COREWEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewWebResourceContext                   = type COREWEBVIEW2_WEB_RESOURCE_CONTEXT;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewCookieSameSiteKind                   = type COREWEBVIEW2_COOKIE_SAME_SITE_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewHostResourceAcccessKind              = type COREWEBVIEW2_HOST_RESOURCE_ACCESS_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewDownloadState                        = type COREWEBVIEW2_DOWNLOAD_STATE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewDownloadInterruptReason              = type COREWEBVIEW2_DOWNLOAD_INTERRUPT_REASON;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewClientCertificateKind                = type COREWEBVIEW2_CLIENT_CERTIFICATE_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewBrowserProcessExitKind               = type COREWEBVIEW2_BROWSER_PROCESS_EXIT_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMouseEventKind                       = type COREWEBVIEW2_MOUSE_EVENT_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMouseEventVirtualKeys                = type COREWEBVIEW2_MOUSE_EVENT_VIRTUAL_KEYS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPointerEventKind                     = type COREWEBVIEW2_POINTER_EVENT_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewBoundsMode                           = type COREWEBVIEW2_BOUNDS_MODE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewProcessFailedReason                  = type COREWEBVIEW2_PROCESS_FAILED_REASON;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintOrientation                     = type COREWEBVIEW2_PRINT_ORIENTATION;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewColor                                = type COREWEBVIEW2_COLOR;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewDefaultDownloadDialogCornerAlignment = type COREWEBVIEW2_DEFAULT_DOWNLOAD_DIALOG_CORNER_ALIGNMENT;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewProcessKind                          = type COREWEBVIEW2_PROCESS_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMenuItemKind                         = type COREWEBVIEW2_CONTEXT_MENU_ITEM_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMenuTargetKind                       = type COREWEBVIEW2_CONTEXT_MENU_TARGET_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPDFToolbarItems                      = type COREWEBVIEW2_PDF_TOOLBAR_ITEMS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPreferredColorScheme                 = type COREWEBVIEW2_PREFERRED_COLOR_SCHEME;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewBrowsingDataKinds                    = type COREWEBVIEW2_BROWSING_DATA_KINDS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewServerCertificateErrorAction         = type COREWEBVIEW2_SERVER_CERTIFICATE_ERROR_ACTION;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewFaviconImageFormat                   = type COREWEBVIEW2_FAVICON_IMAGE_FORMAT;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintCollation                       = type COREWEBVIEW2_PRINT_COLLATION;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintColorMode                       = type COREWEBVIEW2_PRINT_COLOR_MODE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintDuplex                          = type COREWEBVIEW2_PRINT_DUPLEX;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintMediaSize                       = type COREWEBVIEW2_PRINT_MEDIA_SIZE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintStatus                          = type COREWEBVIEW2_PRINT_STATUS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewPrintDialogKind                      = type COREWEBVIEW2_PRINT_DIALOG_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewSharedBufferAccess                   = type COREWEBVIEW2_SHARED_BUFFER_ACCESS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewTrackingPreventionLevel              = type COREWEBVIEW2_TRACKING_PREVENTION_LEVEL;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewMemoryUsageTargetLevel               = type COREWEBVIEW2_MEMORY_USAGE_TARGET_LEVEL;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewNavigationKind                       = type COREWEBVIEW2_NAVIGATION_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewFrameKind                            = type COREWEBVIEW2_FRAME_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewWebResourceRequestSourceKind         = type COREWEBVIEW2_WEB_RESOURCE_REQUEST_SOURCE_KINDS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewNonClientRegionKind                  = type COREWEBVIEW2_NON_CLIENT_REGION_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewChannelSearchKind                    = type COREWEBVIEW2_CHANNEL_SEARCH_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewReleaseChannels                      = type COREWEBVIEW2_RELEASE_CHANNELS;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewScrollBarStyle                       = type COREWEBVIEW2_SCROLLBAR_STYLE;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewFileSystemHandlePermission           = type COREWEBVIEW2_FILE_SYSTEM_HANDLE_PERMISSION;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewFileSystemHandleKind                 = type COREWEBVIEW2_FILE_SYSTEM_HANDLE_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewTextDirectionKind                    = type COREWEBVIEW2_TEXT_DIRECTION_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewSaveAsKind                           = type COREWEBVIEW2_SAVE_AS_KIND;
  /// <summary>
  ...
  /// </remarks>
  TEdgeWebViewSaveAsUIResult                       = type COREWEBVIEW2_SAVE_AS_UI_RESULT;
  /// <summary>
  /// TEdgeWebViewLoader status values
  /// </summary>
  TEdgeWebView2LoaderStatus = (wvlsCreated,
                      wvlsLoading,
                      wvlsLoaded,
                      wvlsImported,
                      wvlsInitialized,
                      ...
                      wvlsUnloaded);
  /// <summary>
  /// Event type used by TEdgeWebViewBrowserBase.SimulateKeyEvent
  /// </summary>
  TEdgeWebView2KeyEventType = (ketKeyDown,
                      ketKeyUp,
                      ketRawKeyDown,
                      ketChar);
  /// <summary>
  /// Debug log values used by TEdgeWebViewLoader.DebugLog
  /// </summary>
  TEdgeWebView2DebugLog = (dlDisabled,
                  dlEnabled,
                  dlEnabledStdOut,
                  dlEnabledStdErr);
  /// <summary>
  ...
  /// </summary>
  TEdgeWebView2DebugLogLevel = (dllDefault,
                       dllInfo,
                       dllWarning,
                       dllError,
                       dllFatal);
  ...
  /// </remarks>
  TEdgeWebView2EditingCommand = (ecAlignCenter,
                        ecAlignJustified,
                        ecAlignLeft,
                        ecAlignRight,
                        ecBackColor,
  ...
  /// </summary>
  TEdgeWebViewWindowFeatures = record
    HasPosition             : boolean;
    HasSize                 : boolean;
    Left                    : cardinal;
    Top                     : cardinal;
  ...
  /// <summary>
  /// Used by TEdgeWebViewBrowserBase.ClearDataForOrigin to clear the storage
  /// </summary>
  TEdgeWebViewClearDataStorageTypes = (cdstAppCache,
                              cdstCookies,
                              cdstFileSystems,
                              cdstIndexeddb,
                              cdstLocalStorage,
  ...
  /// <summary>
  /// Autoplay policy types used by TEdgeWebViewLoader.AutoplayPolicy. See the --autoplay-policy switch.
  /// </summary>
  TEdgeWebViewAutoplayPolicy = (appDefault,
  ...
  /// </summary>
  TEdgeWebViewCustomSchemeInfo = record
    /// <summary>
  ...
  TEdgeWebViewCustomSchemeInfoArray = array of TEdgeWebViewCustomSchemeInfo;
  TEdgeWebViewCustomSchemeRegistrationArray = array of ICoreWebView2CustomSchemeRegistration;
implementation
end.
