...
constructor TEdgeAdvancedPopupManager.Create(AOwnerForm: TForm = nil);
begin
  inherited Create;
...
procedure TEdgeAdvancedPopupManager.CloseAllPopups;
var
  i: Integer;
begin
  if Assigned(FPopups) then
...
procedure TEdgeAdvancedPopupManager.CleanupAndDestroy;
begin
  CloseAllPopups;
...
procedure TEdgeAdvancedPopupManager.CreateMainBrowser;
const
  MAIN_HTML =
    '<!DOCTYPE html>' +
    '<html>' +
...
procedure TEdgeAdvancedPopupManager.OnMessageReceived(Sender: TObject; const Message: string);
var
  JsonMsg: TJSONObject;
  Action: string;
begin
...
procedure TEdgeAdvancedPopupManager.CreateLoginPopup;
const
  LOGIN_HTML =
    '<!DOCTYPE html>' +
    '<html>' +
...
procedure TEdgeAdvancedPopupManager.CreateDataEntryPopup;
const
  DATA_ENTRY_HTML =
    '<!DOCTYPE html>' +
    '<html>' +
